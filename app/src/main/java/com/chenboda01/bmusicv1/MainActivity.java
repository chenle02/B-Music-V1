package com.chenboda01.bmusicv1;
...
public class MainActivity extends Activity {
        ...
        public void openUrl(String url) {
            runOnUiThread(() -> {
                try {
                    ...
                    Toast.makeText(MainActivity.this, "Could not open link.", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
    ...
    public void onBackPressed() {
        webView.evaluateJavascript("window.bmusicBack && window.bmusicBack()", null);
    }
}
